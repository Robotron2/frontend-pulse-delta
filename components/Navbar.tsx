      ...
      <div className="relative z-[60] bg-black/20 backdrop-blur-lg transition-all duration-200">
        <div className="container mx-auto px-4 pt-4 pb-4">
          <div className="flex items-center justify-between h-12">
            ...
            >
              <span className="text-foreground">
                <span className="animate-pulse duration-100 ease-in-out">
                  Pulse
                </span>
                Delta
              </span>
            ...
            <div className="flex items-center gap-4">
              <Button
                ...
                className="hidden md:inline-flex shadow-md shadow-gray-800 hover:bg-primary-dark transition-colors"
              >
                {isConnected
